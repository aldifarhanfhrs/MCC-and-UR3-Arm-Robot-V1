...
img_b64 = get_image64(r"C:\Users\aldif\OneDrive\Documents\Semester VII\Python\MCC ALDI\Cam OFF.png")

top_banner = [sg.Column([[
    sg.Text('COMPUTER VISION (INDIVIDUAL) CHECKING' + ' ' * 175,
            font=('Impact 30'), background_color=DARK_HEADER_COLOR),
    sg.Text(' ', font='Any 30', key='timetext',
            background_color=DARK_HEADER_COLOR, justification= 'right')
]], size=(img_Setting + img_WIDTH + 1000, 65), pad=((0, 0), (0, 0)), background_color=DARK_HEADER_COLOR
)]
...
set_column = [sg.Column(
    [
        ...
        [sg.Output(size=(50, 20), font='Courier 10')]])]
    ], background_color=BORDER_COLOR
)]
###################################################################################
##################    Fungsi Image, Setting, Layout, dan Window  ##################
...
content_layout = [
    ...
    sg.Column(cnt_setting,
              size=(img_Setting+100, img_HEIGHT+330),
              pad=((310, 0), (0, 0)),
              background_color=BORDER_COLOR)]
